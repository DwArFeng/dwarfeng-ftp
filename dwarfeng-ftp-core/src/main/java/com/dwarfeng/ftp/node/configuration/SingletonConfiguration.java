...
public class SingletonConfiguration {
    ...
    public static final String SPEL_TEMPORARY_FILE_DIRECTORY_PATH = "${ftp.temporary_file_directory_path:" +
            "#{T(com.dwarfeng.ftp.stack.struct.FtpConfig$Builder).DEFAULT_TEMPORARY_FILE_DIRECTORY_PATH}}";
    ...
    public static final String SPEL_TEMPORARY_FILE_PREFIX = "${ftp.temporary_file_prefix:" +
            "#{T(com.dwarfeng.ftp.stack.struct.FtpConfig$Builder).DEFAULT_TEMPORARY_FILE_PREFIX}}";
    ...
    public static final String SPEL_TEMPORARY_FILE_SUFFIX = "${ftp.temporary_file_suffix:" +
            "#{T(com.dwarfeng.ftp.stack.struct.FtpConfig$Builder).DEFAULT_TEMPORARY_FILE_SUFFIX}}";
    ...
    public static final String SPEL_FILE_COPY_MEMORY_BUFFER_SIZE = "${ftp.file_copy_memory_buffer_size:" +
            "#{T(com.dwarfeng.ftp.stack.struct.FtpConfig$Builder).DEFAULT_FILE_COPY_MEMORY_BUFFER_SIZE}}";
    ...
    public static final String SPEL_ACTIVE_REMOTE_DATA_CONNECTION_MODE_SERVER_HOST =
            "${ftp.active_remote_data_connection_mode_server_host:" +
                    "#{T(com.dwarfeng.ftp.stack.struct.FtpConfig$Builder)" +
    ...
    @Value("${ftp.port:#{T(com.dwarfeng.ftp.stack.struct.FtpConfig$Builder).DEFAULT_PORT}}")
    private int port;

    @Value("${ftp.server_charset:#{T(com.dwarfeng.ftp.stack.struct.FtpConfig$Builder).DEFAULT_SERVER_CHARSET}}")
    private String serverCharset;

    @Value("${ftp.connect_timeout:#{T(com.dwarfeng.ftp.stack.struct.FtpConfig$Builder).DEFAULT_CONNECT_TIMEOUT}}")
    private int connectTimeout;

    @Value("${ftp.noop_interval:#{T(com.dwarfeng.ftp.stack.struct.FtpConfig$Builder).DEFAULT_NOOP_INTERVAL}}")
    private long noopInterval;

    @Value("${ftp.buffer_size:#{T(com.dwarfeng.ftp.stack.struct.FtpConfig$Builder).DEFAULT_BUFFER_SIZE}}")
     ...
     * @since 1.3.0
     */
    @Value("${ftp.data_connection_mode:#{T(com.dwarfeng.ftp.stack.struct.FtpConfig$Builder).DEFAULT_DATA_CONNECTION_MODE}}")
    private int dataConnectionMode;

    /**
     * @since 1.3.0
     */
    @Value("${ftp.data_timeout:#{T(com.dwarfeng.ftp.stack.struct.FtpConfig$Builder).DEFAULT_DATA_TIMEOUT}}")
