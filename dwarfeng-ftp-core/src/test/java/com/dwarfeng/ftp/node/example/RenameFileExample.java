...
public class RenameFileExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 显示欢迎信息并获取展示功能用的根文件夹。
        CT.trace("开发者您好!");
        CT.trace("这是一个示例, 用于演示 dwarfeng-ftp 的重命名文件功能");
        ...
        CT.trace("文件重命名完毕, 您将会看到文件被重命名");
        System.out.print("请按回车键继续...");
        scanner.nextLine();

        // 3. 旧文件不存在的情形。
        CT.trace("");
        CT.trace("3. 旧文件不存在的情形...");
        try {
            ftpHandler.renameFile(
        ...
        CT.trace("您将在警告级别以下的日志中看到异常信息");
        System.out.print("请按回车键继续...");
        scanner.nextLine();

        // 4. 文件重命名，覆盖已存在的文件。
        CT.trace("");
        CT.trace("4. 文件重命名，覆盖已存在的文件...");
        ftpHandler.renameFile(
                new String[]{rootPath, "漫画の少女"}, "漫画の少女.jpg",
                new String[]{rootPath, "漫画女孩"}, "漫画女孩.jpg"
        );
        CT.trace("文件重命名完毕, 您将会看到文件被重命名, 且已经存在的目标文件被覆盖");
        System.out.print("请按回车键继续...");
        scanner.nextLine();
