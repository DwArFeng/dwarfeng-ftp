...
public class CopyFileExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 显示欢迎信息并获取展示功能用的根文件夹。
        CT.trace("开发者您好!");
        CT.trace("这是一个示例, 用于演示 dwarfeng-ftp 的复制文件功能");
