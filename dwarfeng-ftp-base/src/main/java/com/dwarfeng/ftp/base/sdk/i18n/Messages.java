package com.dwarfeng.ftp.base.sdk.i18n;

import com.dwarfeng.ftp.base.internal.i18n.ResourceMessageResolver;
import com.dwarfeng.ftp.base.stack.i18n.MessageCatalog;
import com.dwarfeng.ftp.base.stack.i18n.MessageResolver;
 ...
 *
 * <p>
 * 该工具为 Dwarfeng FTP 各模块提供统一的语言环境调度、资源查找、格式化与缺失资源降级。
 *
 * <p>
 * 该类型属于 Dwarfeng FTP 内部集成机制。
 *
 * @author DwArFeng
 * @since 3.0.0
 */
